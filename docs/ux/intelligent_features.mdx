...
## User interviews
Hoci návrh inteligentných funkcií vychádzal z existujúceho používateľského výskumu, rozhodli sme sa dizajn proces podporiť ďalšou metódou. Realizovali sme používateľské rozhovory s cieľom zistiť ako ľudia pristupujú k organizácii kníh a učebných materiálov, digitálnym knižniciam a čítačkám kníh. Chceli sme identifikovať ich potreby, frustrácie a tiež zistiť ich názor na nami navrhované funkcie. Rozhovory prebehli s 3 účastníkmi a boli spojené s testovaním PDF čítačky (viewer).
...
Na základe spätnej väzby participantov sme upravili návrhy, z hľadiska funkcionality i dizajnu. Najvýznamnejšie zmeny prebehli v inteligetných výsledkoch vyhľadávania - funkcie 8.1 a 8.2:
